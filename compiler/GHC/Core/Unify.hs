...
isAppHeadMatchable (TyVarTy _ Matchable)          = True
isAppHeadMatchable (TyVarTy _ MaybeUnmatchable)   = False
isAppHeadMatchable (AppTy th _)                   = isAppHeadMatchable th
isAppHeadMatchable (TyConApp tc _)                = isMatchableTyCon tc
isAppHeadMatchable _                              = False
...
unify_tc_app env tc tys1 tys2
  ...
  , (_mult1 : _mat1 : no_mult_tys1) <- tys1
  , (_mult2 : _mat2 : no_mult_tys2) <- tys2
