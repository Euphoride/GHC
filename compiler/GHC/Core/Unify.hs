...
-- isAppHeadMatchable (TyVarTy tv _) = isMatchableKind (tyVarKind tv)
...
-- isMatchableKind :: Kind -> Bool
-- isMatchableKind ki = case ki of
--   FunTy { ft_mat = mat } -> mat == matchableDataCon
