...
module GHC.Core.TyCo.Rep (
        ...
        Matchability(..), tyVarMatchability, mkMatchableVisFunTysMany, setUnmatchable, countSpine
    ) where
...
countSpine :: Type -> Int
countSpine (ForAllTy bndr ty) = countSpine ty
countSpine (FunTy af mult mat arg res) = countSpine res + 1
countSpine _ = 0
